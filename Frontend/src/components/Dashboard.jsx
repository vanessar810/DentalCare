                            ...
                            <div className="bg-white rounded-lg shadow p-6 dark:bg-gray-800">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm text-gray-900">{ userData.name + " " + userData.lastname}</p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-500">Document of identification</label>
                                        <p className="mt-1 text-sm text-gray-900">{userData.dni}</p>
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium text-gray-500">Address</label>
                                        <p className="mt-1 text-sm text-gray-900">{userData.address.street + ", " + userData.address.number + ", " + userData.address.neighborhood}</p>
                                    </div>
                                    <div>
